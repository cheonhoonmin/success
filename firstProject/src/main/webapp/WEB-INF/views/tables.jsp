				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">공지사항필독</h6>
						</div>
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<tr>
										<td colspan="4" align="right"><input type="button" class="page-link"
											value="글쓰기" onclick="location.href='insert.do'"></td>
									</tr>
								</table>
